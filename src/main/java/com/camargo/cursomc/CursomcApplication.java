...
import com.camargo.cursomc.domain.ItemPedido;
import com.camargo.cursomc.domain.Pagamento;
import com.camargo.cursomc.domain.PagamentoComBoleto;
import com.camargo.cursomc.domain.PagamentoComCartao;
import com.camargo.cursomc.domain.Pedido;
import com.camargo.cursomc.domain.Produto;
import com.camargo.cursomc.domain.enums.EstadoPagamento;
...
import com.camargo.cursomc.repositories.ItemPedidoRepository;
import com.camargo.cursomc.repositories.PagamentoRepository;
...
public class CursomcApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Pedido ped1 = new Pedido(null, sdf.parse("30/09/2017 11:00"), cli1, e1);
		Pedido ped2 = new Pedido(null, sdf.parse("10/10/2017 11:58"), cli1, e2);
